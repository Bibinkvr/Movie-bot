...
// BulkWrite executes a bulk write operation on the current storage collection.
func (c *MultiCollection) BulkWrite(ctx context.Context, models []mongo.WriteModel, opts ...*options.BulkWriteOptions) (*mongo.BulkWriteResult, error) {
	return c.storageCollection.BulkWrite(ctx, models, opts...)
}
