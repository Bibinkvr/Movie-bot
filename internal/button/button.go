...
// Unwrap changes InlineKeyboardButton to gotgbot.InlineKeyboardButton.
func (val InlineKeyboardButton) Unwrap() gotgbot.InlineKeyboardButton {
...
func UnwrapKeyboard(input [][]InlineKeyboardButton) [][]gotgbot.InlineKeyboardButton {
	...
	for _, row := range input {
		...
		for _, btn := range row {
			newRow = append(newRow, btn.Unwrap())
		}
